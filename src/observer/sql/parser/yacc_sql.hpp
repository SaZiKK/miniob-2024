...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    VEC_L2_DISTANCE = 320,         /* VEC_L2_DISTANCE  */
    VEC_COSINE_DISTANCE_FUNC = 321, /* VEC_COSINE_DISTANCE_FUNC  */
    VEC_INNER_PRODUCT_FUNC = 322,  /* VEC_INNER_PRODUCT_FUNC  */
    ...
    SSS = 335,                     /* SSS  */
    HIGHER_THAN_EXPRESSION = 336,  /* HIGHER_THAN_EXPRESSION  */
    UMINUS = 337                   /* UMINUS  */
  };
